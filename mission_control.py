...
dados_missao = [
    ...
    [31, 72, 65, 92, 74],  # Ciclo 3 — Aquecimento moderado
    ...
    [36, 48, 31, 82, 45],  # Ciclo 7 — Redução parcial dos alertas
    [29, 68, 52, 89, 63],  # Ciclo 8 — Sistemas ainda abaixo do nível inicial
]
