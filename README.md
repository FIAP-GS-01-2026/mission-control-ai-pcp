...
Disciplina: Pensamento Computacional e Automação com Python Instituição: FIAP — Global Solution 2026.1 Equipe: Equipe GGT
Integrante
RM
Turma
Glauco Kelly
...
mission-control-ai-pcp/ ├── README.md └── mission_control.py
--------------------------------------------------------------------------------
Vídeo pitch
